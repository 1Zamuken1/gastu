-- Creación de tabla de proyección de ingresos (programados)
CREATE TABLE IF NOT EXISTS proyeccion_ingreso (
    proyeccion_ingreso_id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
    ...
    -- Foreign Keys
    CONSTRAINT fk_proyeccion_ingreso_usuario
        FOREIGN KEY (usuario_id)
        REFERENCES usuario(usuario_id)
        ON DELETE RESTRICT
        ON UPDATE CASCADE,

    CONSTRAINT fk_proyeccion_ingreso_concepto
